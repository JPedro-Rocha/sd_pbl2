...
urlpatterns = [
    ...
    url(r'^(?P<slug>[a-zA-Z1-9]+)/remove/(?P<poss>[0-9])/$', views.remov_temp, name="remove_temp"),
    url(r'^(?P<slug>[a-zA-Z1-9]+)/atualizar_temporizador/(?P<pos>[0-9])/$', views.atualizar_temporizador, name="modifica_temporizador"),
